...
(function () {
  ...
  var menus = [
    { label:'☰ &nbsp;PHI-Catalog', items:[
      ...
      {n:'6',i:'📋',t:'BOM List',                 h:'BOM List.html'},
    ]},
    { label:'🧮 &nbsp;Calculator Design', items:[
      ...
      {n:'3',i:'✖️',t:'Solenoid Valve & Manifold Selector',      h:'Solenoid Valve & Manifold Selector.html'},
      {n:'4',i:'➗',t:'Calculator Item 4', h:'calculator-design/item4.html'},
      {n:'5',i:'📐',t:'Calculator Item 5', h:'calculator-design/item5.html'},
      {n:'6',i:'📏',t:'Calculator Item 6', h:'calculator-design/item6.html'},
    ]},
    { label:'🏢 &nbsp;ข้อมูลภายในองค์กร', items:[
      {n:'1',i:'📋',t:'Internal Item 1', h:'internal-data/item1.html'},
      {n:'2',i:'📊',t:'Internal Item 2', h:'internal-data/item2.html'},
      {n:'3',i:'📈',t:'Internal Item 3', h:'internal-data/item3.html'},
      {n:'4',i:'📉',t:'Internal Item 4', h:'internal-data/item4.html'},
      {n:'5',i:'🗂️',t:'Internal Item 5', h:'internal-data/item5.html'},
      {n:'6',i:'🗃️',t:'Internal Item 6', h:'internal-data/item6.html'},
    ]},
    { label:'📂 &nbsp;Data1', items:[
      {n:'1',i:'🔵',t:'Data1 Item 1', h:'data1/item1.html'},
      {n:'2',i:'🟢',t:'Data1 Item 2', h:'data1/item2.html'},
      {n:'3',i:'🟡',t:'Data1 Item 3', h:'data1/item3.html'},
      {n:'4',i:'🟠',t:'Data1 Item 4', h:'data1/item4.html'},
      {n:'5',i:'🔴',t:'Data1 Item 5', h:'data1/item5.html'},
      {n:'6',i:'🟣',t:'Data1 Item 6', h:'data1/item6.html'},
    ]},
    { label:'📁 &nbsp;Data2', items:[
